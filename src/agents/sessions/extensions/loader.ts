...
// avoiding a circular dependency. Extensions can import from openclaw/plugin-sdk/agent-sessions.
import * as bundledAgentSessions from "../index.js";
...
function getAliases(): Record<string, string> {
  ...
  const packageIndex = path.resolve(currentDirname, "..", "index.js");

  const typeboxEntry = require.resolve("typebox");
  const typeboxCompileEntry = require.resolve("typebox/compile");
  const typeboxValueEntry = require.resolve("typebox/value");

  const agentSessionsEntry = packageIndex;
